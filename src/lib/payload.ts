...
## قوانین ویرایش
- فقط و فقط یک بلوک JSON برگردان، بدون توضیح اضافه. من مستقیم پیستش می‌کنم.
...
{ "id": string, "title": string, "due": string|null, "repeat": "none"|"daily"|"weekly"|"monthly",
  "done": boolean, "createdAt": string, "doneAt": string|null, "notifiedAt": string|null, "tags": string[] }

## اسکیمای یادداشت
{ "id": string, "text": string, "createdAt": string }

## تنظیمات
{ "sound": boolean, "notifications": boolean, "checkIntervalSec": number, "leadMinutes": number }
`;
...
/** متن کاملی که برای AI کپی می‌شود: توضیح هدف + اسکیما + کل دیتا. */
